...
def decoratore_func(fun):
    def wrapper(*args):
        ...
        if args in dict_memory.keys():  # если наш аргумент равен ключу из переменной "р" то мы выводим значение этого ключа
...
def func(*args: int or float):
    ...
    dict_memory[args] = sum_args  # Добовляем в нашу переменную ключ-значение. Где ключь - это аргументы функции, а значение сумма этих
    # аргументов
    print(sum_args)
